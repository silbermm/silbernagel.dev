defmodule SilbernageldevWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SilbernageldevWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/silbernageldev_web/templates",
        namespace: SilbernageldevWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SilbernageldevWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import SilbernageldevWeb.ErrorHelpers
      import SilbernageldevWeb.Gettext
      alias SilbernageldevWeb.Router.Helpers, as: Routes
    end
  end
